...
type PromotionCodeInitParameters struct {
...
type PromotionCodeObservation struct {
...
type PromotionCodeParameters struct {
...
// PromotionCodeSpec defines the desired state of PromotionCode
type PromotionCodeSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     PromotionCodeParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider PromotionCodeInitParameters `json:"initProvider,omitempty"`
}

// PromotionCodeStatus defines the observed state of PromotionCode.
type PromotionCodeStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        PromotionCodeObservation `json:"atProvider,omitempty"`
}
...
// PromotionCode is the Schema for the PromotionCodes API. The Stripe Promotion Code can be created, modified and configured by this resource.
...
type PromotionCode struct {
	...
	Spec   PromotionCodeSpec   `json:"spec"`
	Status PromotionCodeStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// PromotionCodeList contains a list of PromotionCodes
type PromotionCodeList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []PromotionCode `json:"items"`
}

// Repository type metadata.
var (
	PromotionCode_Kind             = "PromotionCode"
	PromotionCode_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: PromotionCode_Kind}.String()
	PromotionCode_KindAPIVersion   = PromotionCode_Kind + "." + CRDGroupVersion.String()
	PromotionCode_GroupVersionKind = CRDGroupVersion.WithKind(PromotionCode_Kind)
)

func init() {
	SchemeBuilder.Register(&PromotionCode{}, &PromotionCodeList{})
}
